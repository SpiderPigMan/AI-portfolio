    ...
    <div className="relative flex flex-col items-center">
      <section className="w-full py-16 flex flex-col items-center text-center">
        ...
        <div className="w-full max-w-4xl group relative">
          ...
          <div className="glass-card relative w-full h-[600px] flex flex-col overflow-hidden">
            {/* Cabecera Estilo Mac (Semáforos) */}
            ...
            {/* Componente ChatWidget que usa las clases .chat-* */}
            <ChatWidget />
          </div>
        </div>
      </section>
